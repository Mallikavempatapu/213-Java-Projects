package com.databaseoperarions;
...
import com.mydatabase.DBConnection;
    ...
    public DBOperations() {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                try {
                        ...
                        DBConnection conn = new DBConnection(props.getProperty("url"), props.getProperty("root"), props.getProperty("mallikaR17"));
